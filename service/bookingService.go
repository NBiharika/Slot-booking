...
func (service *bookingService) CountAllBookedSlotsOfAUser(booking entity.Booking, date string) (int64, error) {
	return service.bookings.CountAllBookedSlotsOfAUser(booking, date)
}
